  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement): {
      ...
      if (halfFloatTexType === null) {
        throw new Error("HALF_FLOAT texture type not supported");
      }

      let formatRGBA: ExtensionFormats;
      let formatRG: ExtensionFormats;
      let formatR: ExtensionFormats;
    ...
    const blit = (() => {
      ...
      if (!indexBuffer) throw new Error("Failed to create WebGL index buffer");
